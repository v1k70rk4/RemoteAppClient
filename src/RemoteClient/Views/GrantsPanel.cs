...
public sealed class GrantsPanel : UserControl
{
    ...
    private readonly MaterialComboBox _groups = new() { Hint = L.BootstrapView_035 };
    private readonly MaterialComboBox _devices = new() { Hint = L.DevicesView_003 };
    ...
    public GrantsPanel(AdminApi api, Guid userId)
    {
        ...
        _list.Columns.Add(L.GrantsPanel_001, 440);
        ...
        _groups.Width = 250;
        var addGroup = new MaterialButton { Text = L.GrantsPanel_004, AutoSize = true, Margin = new Padding(10, 4, 4, 0) };
        ...
        _devices.Width = 250;
        var addDevice = new MaterialButton { Text = L.GrantsPanel_003, AutoSize = true, Margin = new Padding(10, 4, 4, 0) };
    ...
    private async Task RefreshAsync()
    {
        try
        {
            ...
            {
                var item = new ListViewItem(g.GroupId is not null ? L.BootstrapView_035 : L.DevicesView_003) { Tag = g };
