...
[JsonSerializable(typeof(Admin.TrustedDeviceInfo))]
[JsonSerializable(typeof(Admin.ServerUpdateStatus))]
[JsonSerializable(typeof(Admin.ServerUpdateResult))]
[JsonSerializable(typeof(Admin.ServerBackupStatus))]
[JsonSerializable(typeof(Admin.ServerDiag))]
[JsonSerializable(typeof(Admin.ApiTokenInfo))]
[JsonSerializable(typeof(Admin.ApiTokenCreateRequest))]
[JsonSerializable(typeof(Admin.ApiTokenCreated))]
...
[JsonSerializable(typeof(Admin.VncSecretInfo))]
...
[JsonSerializable(typeof(System.Collections.Generic.List<Admin.ApiTokenInfo>))]
